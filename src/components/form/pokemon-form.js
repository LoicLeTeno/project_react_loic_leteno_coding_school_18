...
function PokemonForm({ pokemon, isEditForm }) {
    ...
    const addPokemon = () => {
        PokemonService.addPokemon(pokemon).then(() => history.push('/'))
    }
                            ...
                            <div className="card-content">
                                ...
                                {isAddForm() && (
                                    <div className="form-group">
                                        ...
                                        <input id="picture" name="picture" type="text" className="form-control" value={form.picture.value} onChange={e => inputChange(e)}></input>
